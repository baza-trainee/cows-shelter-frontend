...
const ShareModal = ({ activeImage, setShowModal }: ShareModalProps) => {
  return (
    <div className="absolute left-[50%] top-[57%] z-[9999] flex h-[30vh] w-[90%] -translate-x-[50%] -translate-y-[50%] flex-col items-center justify-center bg-white p-4 text-center text-black md:top-[50%] md:h-[40vh] md:w-[50%] lg:h-[30vh] lg:w-[30%]">
      <button
