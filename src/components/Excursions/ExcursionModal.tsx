...
const ExcursionModal = () => {
  return (
    <div className="relative w-[71rem] border-2 border-solid border-white bg-darkgray px-[3.75rem] pb-[3.75rem] pt-10">
      <div className="flex gap-10 ">
        <div className="flex flex-col gap-4">
          <div className="flex gap-9">
            <div className="flex gap-3">
              <img src={time_icon} width={24} height={24}></img>
              <span className="default-text text-accent"> 30 - 60 хвилин </span>
            </div>
            <div className="flex gap-3">
        ...
        <div className="flex w-[30.4rem] flex-col justify-between">
          ...
          <p className="default-text text-white">
            Це неповторний досвід, що відкриває перед учасниками світ творчості
            та природи. Ця захоплююча подорож починається у мальовничому селі,
            оточеному зеленими лугами та гірськими хребтами. Після 30-60
            хвилинного контакту з нашими підопічними у людей кардинально
            змінюється моральний стан, спадає психологічна напруга і
            поліпшується загальний стан. Ця екскурсія не лише надає можливість
            відчути взаємодію з природою та мистецтвом, але й залишає незабутні
            спогади про спокій і натхнення, отримані від корів та природи
            навколо.Такі рогаті "психологи" важливі і потрібні в усі часи, а в
            такий нелегкий для нашої країни час, вони вкрай необхідні. Наша
            здрава команда завжди рада новим однодумцям у творенні та розвитку
            такої важливої справи для блага світу.
          </p>
