...
const Confirm = ({ title, onConfirm, setShowConfirm }: ConfirmProps) => {
  return (
    <div className="absolute left-[50%] top-[50%] z-[9999] flex h-[236px] w-[492px] -translate-x-[50%] -translate-y-[50%] flex-col items-center justify-center gap-8 bg-white p-4 text-black shadow-2xl">
